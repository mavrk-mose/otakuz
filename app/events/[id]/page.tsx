        ...
        <div className="space-y-8">
          <div>
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <Badge variant="secondary">
                ...
                {mockEvent.attendees.length} attending
              </Badge>
            </div>
          </div>

          <Card className="p-6">
            <p className="leading-relaxed">{mockEvent.description}</p>
          </Card>
          ...
          <div>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              {mockEvent.tournaments.map((tournament, index) => (
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <div className="space-y-1 text-sm text-muted-foreground">
                        ...
                        <p>{format(new Date(tournament.date), 'PPP')} at {tournament.time}</p>
                      </div>
                    </div>
                  </div>
                </Card>
          ...
          <Card className="p-6">
            <div className="space-y-4">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <p className="font-medium">{format(new Date(mockEvent.date), 'PPP')}</p>
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">{mockEvent.location.address}</p>
                </div>
              </div>
              <div className="pt-4 border-t">
                <p className="text-sm text-muted-foreground mb-1">Ticket Price</p>
                <p className="text-2xl font-bold">${mockEvent.price}</p>
              </div>
                ...
                {Array(10).fill(null).map((_, index) => (
                  <div key={index} className="flex gap-4">
                    <div className="w-20 text-sm text-muted-foreground">
                      {format(new Date(mockEvent.date), 'h:mm a')}
                    </div>
                    <div>
